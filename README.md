...
- Вёрстка по [макету](https://www.figma.com/file/5H3gsn5lIGPwzBPby9jAOo/JavaScript.-Sprint-12?type=design&node-id=0-1&mode=design&t=Il2ewF6WOHQNgvT4-0) страницы регистрации и авторизации, а также модального окна, который информирует пользователя об успешной (или не очень) регистрации;
  ...
  <p align="center"><img src="./src/images/readme__images/вход.png" width="80%"></p>
  <p align="center"><img src="./src/images/readme__images/регистрация.png" width="80%"></p>
  <p align="center"><img src="./src/images/readme__images/успех.png" width="80%"></p>
  <p align="center"><img src="./src/images/readme__images/ошибка.png" width="80%"></p>
  <p align="center"><img src="./src/images/readme__images/зашел.png" width="80%"></p>
  </details>
