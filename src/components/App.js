...
function App() {
  ...
  //функция запрос на получение данных профиля (имя. о себе. аватар)
	...
	const isOpen = isEditAvatarPopupOpen || isEditProfilePopupOpen || isAddPlacePopupOpen || isSuccessPopupOpen || selectedCard || isConfirmPopupOpen;
    ...
    setIsSuccessPopupOpen(true)
    setServerErrorText( 'Что-то пошло не так! Попробуйте ещё раз.' || error || message)
		}
	}
		...
		<CurrentUserContext.Provider value={currentUser}>
			<div className='page'>
				<Routes>
					...
					<Route path='/sign-up' element={ // TODO ./pages
						<>
					...
					<Route path='/sign-in' element={ // TODO ./pages
						<>
